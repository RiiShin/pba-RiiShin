...
public class MyHangerGD : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        for (int iter = 0; iter < 100; ++iter)
        {
            ...
            Vector3 pin_err = pin_def - pin_goal;

            Vector3 dwdt = penalty * pin_err - mass * gravity;

            Vector3 dwdo = penalty * Vector3.Cross(rot * pin, pin_err) - mass * Vector3.Cross(rot * cog, gravity);
